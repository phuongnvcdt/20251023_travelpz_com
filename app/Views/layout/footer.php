...
<footer id="footer">
  <div class="container mt-2">
    ...
    <div class="row footer-ads">
      <div class="col-sm-8 col-xs-12">
        <ins class="kkday-product-media" data-oid="<?= Kkday::ADS_ID ?>" data-amount="3" data-origin="https://kkpartners.kkday.com"></ins>
      </div>

      <div class="col-sm-4 col-xs-12">
        <ins class="klk-aff-widget lazy-iframe" data-adid="<?= Klook::WIDGET_ADID ?>" data-lang="" data-currency="" data-cardH="126" data-padding="0" data-lgH="470" data-edgeValue="655" data-cid="-1" data-tid="-1" data-amount="3" data-prod="dynamic_widget">
          <a href="//www.klook.com/?aid=<?= Klook::AFFILIATE_ID ?>&aff_adid=<?= Klook::WIDGET_ADID ?>" aria-label="klook.com"></a>
        </ins>
      </div>
    </div>
...
<script async type="text/javascript" src="<?= base_url('assets/js/kkday/widget.js') ?>"></script>
