...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form method="post" action="<?= admin_location_link($location, 'update') ?>">
                <div class="mb-3">
                    <label for="en_name" class="form-label">English Name</label>
                    <input type="text" class="form-control" id="en_name" name="en_name" value="<?= esc($location['en_name']) ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="parent_id" name="parent_id">
                        ...
                        <?php foreach ($parents as $p): ?>
                            <option value="<?= $p['id'] ?>" <?= $p['id'] == $location['parent_id'] ? 'selected' : '' ?>>
                                <?= esc($p['en_name']) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
