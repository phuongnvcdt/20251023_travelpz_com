...
<html>
<head>
    <title>Edit translation for location "<?= esc($location['en_name']) ?>"</title>
...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <h3 class="text-center mb-4">Edit translation for location "<?= esc($location['en_name']) ?>"</h3>
            ...
            <form method="post" action="<?= admin_location_trans_link($location, $record, 'update') ?>">
                <div class="mb-3">
