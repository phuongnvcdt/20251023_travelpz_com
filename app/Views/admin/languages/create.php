...
<body class="bg-light">
  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-4">
        <h3 class="text-center mb-4">Add Language</h3>
        ...
        <form method="post" action="<?= admin_language_link(null, 'store') ?>">
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="a_id" name="a_id">
          </div>

          <div class="mb-3">
            <label for="k_code" class="form-label">Klook Code</label>
            <input type="text" class="form-control" id="k_code" name="k_code">
          </div>

          <div class="mb-3">
            <label for="kd_code" class="form-label">Kkday Code</label>
            <input type="text" class="form-control" id="kd_code" name="kd_code">
          </div>
